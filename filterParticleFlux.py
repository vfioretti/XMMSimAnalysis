...
for jfits in xrange(N_fits):
    ...
    while (where_sameevent[-1] < (len(evt_id)-1)):
			while evt_id[temp_index] == evt_id[temp_index+1]:
				...
				sameev_together = zip(sameev_gtime, sameev_vol_id)
									...
									if flag_hit:
										if part_id_det[jdet] == 22:
											...
											if part_id_det[jdet] == 11:
												...
												if part_id_det[jdet] == 4294967285:
...
Phot_cols = fits.ColDefs([Phot_col1, Phot_col2, Phot_col3, Phot_col4, Phot_col5, Phot_col6])
...
Elec_cols = fits.ColDefs([Elec_col1, Elec_col2, Elec_col3, Elec_col4, Elec_col5, Elec_col6])
...
Pos_cols = fits.ColDefs([Pos_col1, Pos_col2, Pos_col3, Pos_col4, Pos_col5, Pos_col6])
